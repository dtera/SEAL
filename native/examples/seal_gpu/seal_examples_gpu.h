...
#include "seal_gpu/utils/utils.h"
...
inline void print_parameters(const seal_gpun::SEALContext &context)
{
    ...
    */
    ...
    std::cout << "|   poly_modulus_degree: " << context_data.parms().polyModulusDegree() << std::endl;
    ...
    */
    ...
    {
        std::cout << "|   plain_modulus: " << context_data.parms().plainModulus().value() << std::endl;
    }
...
*/
inline std::ostream &operator<<(std::ostream &stream, seal_gpun::ParmsID parms_id)
{
    /*

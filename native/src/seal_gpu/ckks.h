    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encode(const std::vector<std::complex<double>> &values, double scale, Plaintext &destination)
        {
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encode(double value, ParmsID parms_id, double scale, Plaintext &destination)
        {
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encode(std::complex<double> value, ParmsID parms_id, double scale, Plaintext &destination)
        {
            encodeInternal(value, parms_id, scale, destination);
        }
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void decode(const Plaintext &plain, std::vector<std::complex<double>> &destination)
        {
    ...
    private:
        ...
        void encodeInternal(double value, ParmsID parms_id, double scale, Plaintext &destination);

        inline void encodeInternal(std::complex<double> value, ParmsID parms_id, double scale, Plaintext &destination)
        {

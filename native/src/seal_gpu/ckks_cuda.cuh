...
namespace seal_gpu
{
    ...
    public:
        ...
        inline void encodePolynomial(
            const std::vector<double> &values, ParmsID parms_id, double scale, PlaintextCuda &destination)
        {
    ...
    private:
        ...
        void encodePolynomialInternal(
            const double *coeffs, std::size_t values_size, ParmsID parms_id, double scale, PlaintextCuda &destination);
        ...
        void encodeInternal(double value, ParmsID parms_id, double scale, PlaintextCuda &destination);

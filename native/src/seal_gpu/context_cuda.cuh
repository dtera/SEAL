...
namespace seal_gpu
{
    ...
    public:
        ...
        public:
            ...
            const EncryptionParametersCuda &parms() const
            {
                return parms_;
            }
        ...
        SEALContextCuda(
            EncryptionParameters parms, bool expand_mod_chain = true, SecurityLevel sec_level = SecurityLevel::tc128)
        ...
        SEALContextCuda(
            EncryptionParametersCuda parms, bool expand_mod_chain = true,
        ...
        inline std::shared_ptr<ContextDataCuda> getContextData(ParmsID parms_id) const
        {
            ...
            return (data != context_data_map_.end()) ? data->second : std::shared_ptr<ContextDataCuda>{ nullptr };
        }
        ...
        inline const ParmsID &keyParmsID() const
        {
            return key_parms_id_;
        }

        inline const ParmsID &firstParmsID() const
        {
            return first_parms_id_;
        }

        inline const ParmsID &lastParmsID() const
        {
        ...
        inline const SEALContext &host() const
        {
            return context_host_;
        }

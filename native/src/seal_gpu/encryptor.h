    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encryptSymmetric(const Plaintext &plain, Ciphertext &destination) const
        {
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encryptZeroSymmetric(ParmsID parms_id, Ciphertext &destination) const
        {
    ...
    private:
        ...
        void encryptZeroInternal(ParmsID parms_id, bool is_asymmetric, Ciphertext &destination) const;

        void encryptInternal(const Plaintext &plain, bool is_asymmetric, Ciphertext &destination) const;

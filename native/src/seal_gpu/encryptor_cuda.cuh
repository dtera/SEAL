...
namespace seal_gpu
{
    ...
    */
    ...
    public:
        ...
        */
        inline void encrypt(const PlaintextCuda &plain, CiphertextCuda &destination) const
        {
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encryptSymmetric(const PlaintextCuda &plain, CiphertextCuda &destination) const
        {
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void encryptZeroSymmetric(ParmsID parms_id, CiphertextCuda &destination) const
        {
    ...
    private:
        ...
        void encryptZeroInternal(ParmsID parms_id, bool is_asymmetric, CiphertextCuda &destination) const;

        void encryptInternal(const PlaintextCuda &plain, bool is_asymmetric, CiphertextCuda &destination) const;

    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void multiplyInplace(Ciphertext &encrypted1, const Ciphertext &encrypted2) const;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void relinearizeInplace(Ciphertext &encrypted, const RelinKeys &relin_keys) const
        {
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void modSwitchToNext(const Ciphertext &encrypted, Ciphertext &destination) const;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void modSwitchTo(const Ciphertext &encrypted, ParmsID parms_id, Ciphertext &destination) const
        {
            destination = encrypted;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void rescaleToNext(const Ciphertext &encrypted, Ciphertext &destination) const;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void rescaleTo(const Ciphertext &encrypted, ParmsID parms_id, Ciphertext &destination) const
        {
            destination = encrypted;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void exponentiateInplace(Ciphertext &encrypted, std::uint64_t exponent, const RelinKeys &relin_keys) const;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void multiplyPlainInplace(Ciphertext &encrypted, const Plaintext &plain) const;
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void multiplyPlain(const Ciphertext &encrypted, const Plaintext &plain, Ciphertext &destination) const
        {
            destination = encrypted;
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        inline void transformToNtt(const Plaintext &plain, ParmsID parms_id, Plaintext &destination_ntt) const
        {
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        void applyGaloisInplace(Ciphertext &encrypted, std::uint32_t galois_elt, const GaloisKeys &galois_keys) const;
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void rotateRowsInplace(Ciphertext &encrypted, int steps, const GaloisKeys &galois_keys) const
        {
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void rotateColumnsInplace(Ciphertext &encrypted, const GaloisKeys &galois_keys) const
        {
            auto scheme = context_.keyContextData()->parms().scheme();
            if (scheme != SchemeType::bfv && scheme != SchemeType::bgv)
            {
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void rotateVectorInplace(Ciphertext &encrypted, int steps, const GaloisKeys &galois_keys) const
        {
        ...
        */
        ...
        @throws std::logic_error if result ciphertext is transparent
        */
        inline void complexConjugateInplace(Ciphertext &encrypted, const GaloisKeys &galois_keys) const
        {
            if (context_.keyContextData()->parms().scheme() != SchemeType::ckks)
            {
                throw std::logic_error("unsupported scheme");
    ...
    private:
        ...
        void modSwitchScaleToNext(const Ciphertext &encrypted, Ciphertext &destination) const;
        ...
        void rotateInternal(Ciphertext &encrypted, int steps, const GaloisKeys &galois_keys) const;

        inline void conjugateInternal(Ciphertext &encrypted, const GaloisKeys &galois_keys) const
        {
            // Verify parameters.

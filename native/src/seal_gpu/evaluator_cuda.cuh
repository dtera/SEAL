...
namespace seal_gpu
{
    ...
    public:
        ...
        void applyKeySwitchingInplace(CiphertextCuda &encrypted, const KSwitchKeysCuda &kswitch_keys) const;
        ...
        inline void relinearizeInplace(CiphertextCuda &encrypted, const RelinKeysCuda &relin_keys) const
        {
            relinearizeInternal(encrypted, relin_keys, 2);
        }

        inline void square(const CiphertextCuda &encrypted, CiphertextCuda &destination) const
        {
            destination = encrypted;
        ...
        void modSwitchToNext(const CiphertextCuda &encrypted, CiphertextCuda &destination) const;
        ...
        inline void modSwitchTo(const CiphertextCuda &encrypted, ParmsID parms_id, CiphertextCuda &destination) const
        {
            destination = encrypted;
        ...
        void rescaleToNext(const CiphertextCuda &encrypted, CiphertextCuda &destination) const;
        ...
        inline void rescaleTo(const CiphertextCuda &encrypted, ParmsID parms_id, CiphertextCuda &destination) const
        {
            destination = encrypted;
        ...
        inline void exponentiate(
            const CiphertextCuda &encrypted, std::uint64_t exponent, const RelinKeysCuda &relin_keys,
            CiphertextCuda &destination) const
        {
            destination = encrypted;
        ...
        void multiplyPlainInplace(CiphertextCuda &encrypted, const PlaintextCuda &plain) const;
        ...
        inline void transformToNtt(const PlaintextCuda &plain, ParmsID parms_id, PlaintextCuda &destination_ntt) const
        {
        ...
        inline void rotateRowsInplace(CiphertextCuda &encrypted, int steps, const GaloisKeysCuda &galois_keys) const
        {
        ...
        inline void rotateRows(
            const CiphertextCuda &encrypted, int steps, const GaloisKeysCuda &galois_keys,
            CiphertextCuda &destination) const
        {
            destination = encrypted;
        ...
        inline void rotateColumnsInplace(CiphertextCuda &encrypted, const GaloisKeysCuda &galois_keys) const
        {
            auto scheme = context_.keyContextData()->parms().scheme();
            if (scheme != SchemeType::bfv && scheme != SchemeType::bgv)
            {
        ...
        inline void rotateVectorInplace(CiphertextCuda &encrypted, int steps, const GaloisKeysCuda &galois_keys) const
        {
        ...
        inline void complexConjugateInplace(CiphertextCuda &encrypted, const GaloisKeysCuda &galois_keys) const
        {
            if (context_.keyContextData()->parms().scheme() != SchemeType::ckks)
            {
                throw std::logic_error("unsupported scheme");
        ...
        CiphertextCuda packLWECiphertexts(
    ...
    private:
        ...
        void switchKeyInplace(
            CiphertextCuda &encrypted, util::ConstDevicePointer<uint64_t> target_iter,
            const KSwitchKeysCuda &kswitch_keys, std::size_t key_index) const;
        ...
        void modSwitchScaleToNext(const CiphertextCuda &encrypted, CiphertextCuda &destination) const;
        ...
        void rotateInternal(CiphertextCuda &encrypted, int steps, const GaloisKeysCuda &galois_keys) const;

        inline void conjugateInternal(CiphertextCuda &encrypted, const GaloisKeysCuda &galois_keys) const
        {
            // Verify parameters.

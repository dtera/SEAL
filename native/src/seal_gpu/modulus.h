        ...
        */
            ...
            std::size_t poly_modulus_degree, SecurityLevel sec_level = SecurityLevel::tc128) noexcept
        {
            ...
            case SecurityLevel::tc128:
                return seal::util::seal_he_std_parms_128_tc(poly_modulus_degree);

            case SecurityLevel::tc192:
                return seal::util::seal_he_std_parms_192_tc(poly_modulus_degree);

            case SecurityLevel::tc256:
                return seal::util::seal_he_std_parms_256_tc(poly_modulus_degree);
    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::logic_error if not enough suitable primes could be found
        */
        static inline std::vector<Modulus> Batching(std::size_t poly_modulus_degree, std::vector<int> bit_sizes)
        {

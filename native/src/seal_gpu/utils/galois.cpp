...
namespace seal_gpu
{
    namespace util
    {
        ...
        void GaloisTool::applyGalois(
            ConstHostPointer<uint64_t> operand, uint32_t galois_elt, const Modulus &modulus,
        ...
        void GaloisTool::applyGaloisNtt(
            ConstHostPointer<uint64_t> operand, uint32_t galois_elt, HostPointer<uint64_t> result) const
        {

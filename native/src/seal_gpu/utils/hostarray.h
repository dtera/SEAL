...
namespace seal_gpu
{
    namespace util
    {
        ...
        public:
            ...
            ConstHostPointer<T> toConst()
            {
                return ConstHostPointer<T>(ptr);
            }
        };
        ...
        public:
            ...
            HostPointer<T> operator+(size_t d) const
            {
                return HostPointer<T>(data + d);
            }

            HostPointer<T> asPointer()
            {
                return HostPointer<T>(data);
            }
        };
        ...
        public:
            ...
            HostDynamicArray(HostArray<T> &&move, size_t size) : internal(std::move(move)), size_(size)
            {}

    ...
    namespace util
    {
        ...
        public:
            ...
            NTTTables(NTTTables &copy)
                : root_(copy.root_), coeff_count_power_(copy.coeff_count_power_), coeff_count_(copy.coeff_count_),
                  modulus_(copy.modulus_), inv_degree_modulo_(copy.inv_degree_modulo_), root_powers_(copy.coeff_count_),
        ...
        */
        HostArray<NTTTables> CreateNTTTables(int coeff_count_power, const std::vector<Modulus> &modulus);
        ...
        inline void nttNegacyclicHarveyLazy(
            HostPointer<uint64_t> operand, std::size_t poly_size, std::size_t coeff_modulus_size,
        ...
        inline void nttNegacyclicHarvey(
            HostPointer<uint64_t> operand, std::size_t coeff_modulus_size, const NTTTables *tables)
        {
            std::size_t d = (1 << tables[0].coeffCountPower());
            for (std::size_t i = 0; i < coeff_modulus_size; i++)

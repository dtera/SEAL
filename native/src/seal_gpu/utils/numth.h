...
namespace seal_gpu
{
    namespace util
    {
        ...
        inline auto xgcd(std::uint64_t x, std::uint64_t y) -> std::tuple<std::uint64_t, std::int64_t, std::int64_t>
        {
            /* Extended GCD:
        ...
        std::vector<std::uint64_t> conjugateClasses(std::uint64_t modulus, std::uint64_t subgroup_generator);

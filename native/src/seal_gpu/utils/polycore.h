...
namespace seal_gpu
{
    namespace util
    {
        ...
        inline auto allocatePoly(std::size_t coeff_count, std::size_t coeff_uint64_count)
        {
        ...
        inline auto allocateZeroPoly(std::size_t coeff_count, std::size_t coeff_uint64_count)
        {
            return allocateZeroUint(util::mul_safe(coeff_count, coeff_uint64_count));
        }

        inline auto allocatePolyArray(std::size_t poly_count, std::size_t coeff_count, std::size_t coeff_uint64_count)
        {

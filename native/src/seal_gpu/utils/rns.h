...
namespace seal_gpu
{
    namespace util
    {
        ...
        public:
            BaseConverter(const RNSBase &ibase, const RNSBase &obase) : ibase_(ibase), obase_(obase)
            {
                initialize();
            }
        ...
        public:
            ...
            */
            RNSTool(std::size_t poly_modulus_degree, const RNSBase &coeff_modulus, const Modulus &plain_modulus);
            ...
            */
            ...
            void divideAndRoundqLastNttInplace(HostPointer<uint64_t> input, const NTTTables *rns_ntt_tables) const;

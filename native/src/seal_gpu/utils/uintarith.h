...
namespace seal_gpu
{
    namespace util
    {
        ...
        inline unsigned char addUint(
            const uint64_t *operand1, std::size_t operand1Uint64Count, const uint64_t *operand2,
            std::size_t operand2Uint64Count, unsigned char carry, std::size_t resultUint64Count, uint64_t *result)
        {
        ...
        inline unsigned char subUint(
            const uint64_t *operand1, std::size_t operand1Uint64Count, const uint64_t *operand2,
            std::size_t operand2Uint64Count, unsigned char borrow, std::size_t resultUint64Count, uint64_t *result)
        {
        ...
        inline unsigned char incrementUint(const uint64_t *operand, std::size_t uint64_count, uint64_t *result)
        {
            return addUint(operand, uint64_count, 1, result);
        }

        inline unsigned char decrementUint(const uint64_t *operand, std::size_t uint64_count, uint64_t *result)
        {
        ...
        inline void leftShiftUint(const uint64_t *operand, int shift_amount, std::size_t uint64_count, uint64_t *result)
        {
        ...
        void divideUintInplace(
            uint64_t *numerator, const uint64_t *denominator, std::size_t uint64_count, uint64_t *quotient);

        inline void divideUint(
            const uint64_t *numerator, const uint64_t *denominator, std::size_t uint64_count, uint64_t *quotient,
            uint64_t *remainder)
        {
        ...
        void divideUint128Uint64Inplace(uint64_t *numerator, uint64_t denominator, uint64_t *quotient);

...
namespace seal_gpu
{
    namespace util
    {
        ...
        void divideUintModInplace(uint64_t *numerator, const Modulus &modulus, size_t uint64_count, uint64_t *quotient)
        {
            // Handle base cases
            if (uint64_count == 2)
            {
        ...
        uint64_t dotProductMod(const uint64_t *operand1, const uint64_t *operand2, size_t count, const Modulus &modulus)
        {

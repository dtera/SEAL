...
namespace seal_gpu
{
    namespace util
    {
        ...
        */
        inline std::uint64_t addUintMod(std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
        ...
        */
        inline std::uint64_t subUintMod(std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
        ...
        */
        inline std::uint64_t multiplyUintMod(std::uint64_t x, MultiplyUIntModOperand y, const Modulus &modulus)
        {
#ifdef SEAL_DEBUG
        ...
        than modulus.
        */
        inline std::uint64_t multiplyUintModLazy(std::uint64_t x, MultiplyUIntModOperand y, const Modulus &modulus)
        {
#ifdef SEAL_DEBUG
            if (y.operand >= modulus.value())
            {
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        std::uint64_t exponentiateUintMod(std::uint64_t operand, std::uint64_t exponent, const Modulus &modulus);

...
namespace seal_gpu
{
    namespace util
    {
        ...
        inline void hexStringToUint(const char *hex_string, int char_count, std::size_t uint64_count, uint64_t *result)
        {
        ...
        inline bool isEqualUint(const uint64_t *value, std::size_t uint64_count, uint64_t scalar)
        {
            if (*value++ != scalar)
            {
                return false;
        ...
        // #endif
        // #endif
        inline bool isBitSetUint(const uint64_t *value, std::size_t uint64_count SEAL_MAYBE_UNUSED, int bit_index)
        {
...
#pragma clang diagnostic pop
        ...
        inline std::size_t getSignificantUint64CountUint(const uint64_t *value, std::size_t uint64_count)
        {
            value += uint64_count - 1;
        ...
        inline std::size_t getNonzeroUint64CountUint(const uint64_t *value, std::size_t uint64_count)
        {
        ...
        inline void setUint(
            const uint64_t *value, std::size_t value_uint64_count, std::size_t result_uint64_count, uint64_t *result)
        {
        ...
        */
        ...
        inline int compareUint(const uint64_t *operand1, const uint64_t *operand2, std::size_t uint64_count)
        {
            int result = 0;
        ...
        inline bool isGreaterThanUint(const uint64_t *operand1, const uint64_t *operand2, std::size_t uint64_count)
        {
        ...
        inline bool isLessThanUint(const uint64_t *operand1, const uint64_t *operand2, std::size_t uint64_count)
        {
            return compareUint(operand1, operand2, uint64_count) < 0;
        }

        inline bool isLessThanOrEqualUint(const uint64_t *operand1, const uint64_t *operand2, std::size_t uint64_count)
        {
            return compareUint(operand1, operand2, uint64_count) <= 0;
        }

        inline bool isEqualUint(const uint64_t *operand1, const uint64_t *operand2, std::size_t uint64_count)
        {
            return compareUint(operand1, operand2, uint64_count) == 0;
        }

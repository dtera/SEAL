...
namespace seal_gpu
{
    ...
    */
    bool isMetadataValidFor(const Plaintext &in, const SEALContext &context, bool allow_pure_key_levels = false);
    ...
    non-data levels) should be considered valid
    */
    bool isMetadataValidFor(const Ciphertext &in, const SEALContext &context, bool allow_pure_key_levels = false);
